 ...
 * @author Admin
 */
@WebServlet(name = "DeleteItemCartServlet", urlPatterns = {"/deleteCart"})
public class DeleteItemCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String id_raw = request.getParameter("idCart");
        ...
        if (listCart.isEmpty()) {
            Cookie cook = new Cookie("cartAll", cartAll);
            response.addCookie(cook);
            response.sendRedirect("Cart.jsp");
        } else {
            session.setAttribute("listcart", listCart);
            Cart cart = new Cart();
            cartAll = cart.convertListToS(listCart);
            Cookie cook = new Cookie("cartAll", cartAll);
            response.addCookie(cook);
