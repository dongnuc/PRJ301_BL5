...
public class DetailServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        Product proDetail = dao.getProByID(Integer.parseInt(pid));
...
//        out.print(listMost.get(0).toString());
        HttpSession session = request.getSession();
        proDetail.setQuantity(1);
        session.setAttribute("detailPro", proDetail);
        
        request.setAttribute("listmost", listMost);
//        request.setAttribute("detailPro", proDetail);
